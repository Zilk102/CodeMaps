...
export const FileTree: React.FC = () => {
  ...
  const { graphData, selectedPath, isLoading, error, setSelectedNode, setSelectedPath } =
    useGraphStore();
